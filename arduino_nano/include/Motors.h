...
class Motors {
 private:
  static constexpr unsigned long VOLTAGE_REQUEST_INTERVAL_MS = 1000;
  // Под пусковой нагрузкой замер бесполезен — даём моторам выйти на режим.
  static constexpr unsigned long VOLTAGE_STARTUP_PERIOD_MS = 30000;

  const uint32_t MOTOR_ID = 0x141;
